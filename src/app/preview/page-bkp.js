				...
				<div
					...
					<div className="absolute max-w-[100%] inset-x-[15%] bottom-[11%] flex items-center justify-between">
						...
						<div className="flex flex-col items-center text-center">
							<p
								className="mt-0 text-[6px] font-bold uppercase text-white"
								style={{
					...
					<div className="absolute max-w-[100%] inset-x-[15%] bottom-[4%] flex items-center justify-between gap-4 text-[11px] font-bold uppercase tracking-[0.12em] text-white">
						<p
							className="max-w-[50%] text-[8px] text-left tracking-tighter"
							style={{
						...
						<p
							className="max-w-[50%] text-[8px] text-right tracking-tighter"
							style={{
								fontFamily: "var(--font-sora)",
							}}>
							{awayTeam.name}
