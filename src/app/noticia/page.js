...
export default function NoticiaForm() {
	...
	function validateForm() {
		if (!newsArt.title.trim()) return "Informe o título da notícia.";
				...
				<div className="mx-auto w-full max-w-xl">
					<div className="mb-6">
						...
						<h1 className="text-3xl font-black tracking-tight text-white">
							Criar arte de notícia
						</h1>

						<p className="mt-2 text-sm leading-6 text-zinc-400">
							Escolha a liga, escreva o título e ajuste a imagem
					...
					<form
						...
						<Field>
							...
							<Textarea
								id="title"
								rows={3}
								placeholder="Ex.: Clube anuncia novo reforço para a próxima temporada"
								value={newsArt.title}
